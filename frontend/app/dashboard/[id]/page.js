            ...
            <main className='p-8 max-w-4xl mx-auto'>
                ...
                <div className='bg-white text-black rounded-lg p-6 shadow-lg'>
                    ...
                    <a
                        href={asset.url}
                        target='_blank'
                        className='bg-blue-500 hover:bg-blue-700 text-white px-6 py-3 rounded-md inline-block transition-all duration-200 mr-5'
                    >
                        Download Asset
                    </a>

                    <button onClick={() => setEditing(true)} className='bg-yellow-500 hover:bg-yellow-700 text-white px-6 py-3 rounded-md inline-block transition-all duration-200 cursor-pointer'>Edit Asset</button>
